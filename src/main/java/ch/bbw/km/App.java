...
// Aufgabe 4.2
//        Sorter.bubbleSortForPeople(persons);
//        for (Person person : persons) {
//            System.out.println("person's name + age " + person.getLastname() + " " + person.getAge());
//        }
//

// Aufgabe 4.3
//    Arrays.sort(persons, new SortByComparator());
//    for (Person person : persons) {
//        System.out.println("person's last name + first name " + person.getLastname() + " " + person.getLastname());
//    }
...
// Aufgabe 4.4
        Arrays.sort(persons, new SortByComparator());
        for (Person person: persons) {
            System.out.println("person's shoe size + height " + person.getShoeSize() + " " + person.getHeight());
        }
    }
}
